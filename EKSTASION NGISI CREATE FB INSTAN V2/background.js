...
function injectClickAction(actionType) {
  function triggerClick(el) {
    ...
    // Pastikan target berada pada elemen interaktif terdekat
    ...
    // Simulasi 1 siklus interaksi kursor lengkap tanpa perulangan induk
  ...
  function findTargetButton(type) {
    ...
    // 1. Deteksi melalui atribut aria-label
    ...
    // 2. Deteksi langsung pada elemen tombol dan interaktif
    ...
    // 3. Deteksi fallback melalui teks terdalam
